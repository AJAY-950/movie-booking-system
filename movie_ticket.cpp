...
int main(){
	...
	do{
		...
		{
    	cout << "Invalid selection - Please select valid input from 1 to 4 only.\n";
	...
	switch(choice)
		{
			...
			cout<<"\n\t\t\t\t 3. Maidaan";
			cout<<"\n\t\t\t\t\t  Hindi";
			cout<<"\n\t\t\t\t\t  Drama,Comedy,Family ,Sports U";
			cout<<"\n\t\t\t\t 4. Tarot ";
			cout<<"\n\t\t\t\t\t  english ";
			cout<<"\n\t\t\t\t\t  horror,thriller,dark U";
			cout<<"\n\t\t\t\t 5. madgaon express";
			cout<<"\n\t\t\t\t\t  hindi";
			cout<<"\n\t\t\t\t\t  Drama,comedy,family U/A\n";
			cout<<"\n\t\t\t\t Enter Your Choice :"<<"\t";
			cin>>movie;
			...
			switch(movie)
			{
				case 1:
					...
					switch(b)
						{
							case 1:	cout<<"08:10 am";
								break;
							case 2:	cout<<"10:45 am";
								break;
							case 3:	cout<<" 01:05 pm";
								break;
							case 4:	cout<<"03:00 pm";
								break;
							case 5:	cout<<"06:00 pm";
								break;
							case 6:	cout<<"08:55 pm";
								break;
		...
		case 3: system("CLS");
				...
				card();
				cout<<"Thank you. \n It will take us  few days  for completing your registration for the card. \n Please see the benefits of the card on the next page. -->";
				char f;
...
{
	int cardid;
	cout<<"\t\t\t\tWelcome to registeration for card facility in our cinemas";
	cout<<" \n\t\t\t\t Enter your name: ";
	cin>>v.name;
	cin.ignore(numeric_limits<streamsize>::max(),'\n'); 
